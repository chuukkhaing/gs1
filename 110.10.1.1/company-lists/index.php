...
<body>
  ...
  <main>
    ...
    <nav class="navbar navbar-expand-lg bg-dark sticky-top">
      <div class="container-fluid">
        ...
        <div class="btn-group" role="group" data-bs-toggle="tooltip" data-bs-placement="left" title="Export">
          <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fa-solid fa-download"></i>
          </button>
          <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <li><a class="dropdown-item" href="../../../regs1/110.10.1.1/export/csv">.csv</a></li>
          </ul>
        </div>
      </div>
    </nav>
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-10">
          <?php
          include("../../../regs1/110.10.1.1/company-lists/retrieve.php");
          ?>
        </div>
      </div>
    </div>
  ...
  <script src="../../../regs1/110.10.1.1/gtins/create.js"></script>
  <!-- fontawesome js -->
