  ...
  <main>
      ...
      <div class="container-fluid">
        ...
        <div class="text-end">
          <span data-bs-toggle="tooltip" data-bs-placement="left" title="Create">
            <button type="button" class="btn btn-primary me-3 rounded-circle" data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-10">
          <?php
            include("../../../regs1/110.10.1.1/gtins/modal.php");
          ?>
          <div id="gtins_retrieve"></div>
        </div>
      </div>
    </div>
  </main>
